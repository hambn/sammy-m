...
module.exports = {
    ...
    run: async function(client, message, args){
        ...
        client.commands.forEach(cmd => {
            ...
            allcmds+="``"+customprefix+cmdinfo.name+" "+cmdinfo.usage+"`` ~ "+cmdinfo.description+"\n"
        })
        ...
        .setFooter(`To get info of each command you can do s!help [command]`)
...
`)
        ...
        client.commands.forEach(cmd => {
            let cmdinfo = cmd.info
            allcmds+="``"+'s!'+cmdinfo.name+" "+cmdinfo.usage+"`` ~ "+cmdinfo.description+"\n"
        })
